...
export function BuyPageClient({ furnitureTypes, initialProducts, initialTotalPages, initialTotal }: Props) {
  ...
  const isDefaultQuery = page === 1 && !search && !selectedType && !selectedCondition && !selectedCity && !minPrice && !maxPrice && sortBy === 'created_at'
  ...
  const { data, isFetching } = useQuery({
    ...
    initialData: isDefaultQuery ? { data: initialProducts, last_page: initialTotalPages, total: initialTotal } as any : undefined,
    staleTime: 60_000,
  })
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onBlur={() => { if (selectedCity) setPage(1) }}
                  ...
                  >
                    ...
                    <div className={`p-4 ${viewMode === 'list' ? 'flex-1 flex flex-col justify-center' : ''}`}>
                      ...
                      <div className="mt-3 flex gap-1.5">
                        <button
                          onClick={(e) => { e.stopPropagation(); handleEmissionClick(product) }}
                        ...
                        <button
                          onClick={(e) => { e.stopPropagation(); handleCompareClick(product) }}
